...
export class CompanyController {
  ...
  updateCompany(@Body() dto: CompanyDto): Promise<OrdersResponseDto> {
  ...
  @Get('/companies')
  findCompanies(@Query() paginationDto: SearchPaginationDto, @Body() inputDto: SearchInputDto): Promise<OrdersResponseDto> {
  ...
  @Get('/companies/:value')
  findOneCompanyByValue(@Param('value') value: string): Promise<OrdersResponseDto> {
  ...
  @Delete('companies/:id')
  removeCompany(@Param('id', ParseUUIDPipe) id: string): Promise<OrdersResponseDto> {
